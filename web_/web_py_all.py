...
usage = """
<html><head><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0"><title>uasge</title></head><body>
uasge:
</br>
</br>
    <a href="/tsf">/tsf<a>    start/stop/list PHP TSF service(in 10.219.134.31)
</br>
    <a href="/wpa">/wpa<a>    add/replace WPA test file(in 10.213.170.99)
</body></html>
"""
